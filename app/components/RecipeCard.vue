<template>
  <article
    class="group overflow-hidden rounded-[1.75rem] bg-white shadow-sm ring-1 ring-stone-200 transition hover:-translate-y-1 hover:shadow-xl hover:shadow-stone-200"
  >
    <div class="relative h-52 overflow-hidden bg-stone-200">
      ...
      <button
        type="button"
        class="absolute right-4 top-4 flex h-12 w-12 items-center justify-center rounded-full border shadow-lg backdrop-blur transition hover:scale-110"
        :class="
          isFavorite
            ? 'border-rose-500 bg-rose-500 text-white shadow-rose-200'
            : 'border-white/80 bg-white/95 text-rose-500 shadow-stone-300 hover:bg-rose-50'
        "
